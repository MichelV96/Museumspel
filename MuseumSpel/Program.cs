...
namespace MuseumSpel
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            foreach (XmlNode eindpunt in eindpunten)
            {
                int x = Int32.Parse(eindpunt.SelectSingleNode("x").InnerText.Trim());
                int y = Int32.Parse(eindpunt.SelectSingleNode("y").InnerText.Trim());
